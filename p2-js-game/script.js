...
const cardContent = [
    ...
    ////////add more 2 more kulam and sumpa cards to deck////////
];
...
///////////////// create pop up window for game over
...
function checkGameOver() {
    ...
    if (player1LifePoints <= 0) {
        ...
        updatePlayer1LifeBar();
        setTimeout(() => {
            const result = window.confirm('Sorry, you lost!\nDo you want to restart the game?');
            if (result) {
                restartGame();
            }
        }, 1000);
        ...
        updatePlayer2LifeBar();
        setTimeout(() => {
            const result = window.confirm('Congratulations! You won!\nIsa kang tunay na mamaw!\nDo you want to restart the game?');
            if (result) {
                restartGame();
            }
        }, 1000);
